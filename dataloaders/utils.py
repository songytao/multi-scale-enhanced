...
def get_prec_recall(preds, labels):
    ...
    # preds_ = torch.from_numpy(preds_).unsqueeze(0)
    # print("preds_ shape:", preds_.shape)
    # preds_ = preds_.unsqueeze(0)
    preds_ = preds_.squeeze(0)
    labels_ = labels_.squeeze(0)
    # print("preds_ shape:", preds_.shape)
    # print("labels_ shape:", labels_.shape)
    # print("preds_ dim:", preds_.dim())
    # print("labels_ dim:", labels_.ndim())
    # print(len(preds_.shape),len(labels_.shape))
