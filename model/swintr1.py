...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, patch_size=4, base_chanel = 16,in_chans=3, num_classes=1000,
        ...
        self.outconv4 = DoubleConv(32*self.base_chanel,1)
        ...
        self.outconv3 = DoubleConv(16*self.base_chanel,1)
        ...
        self.outconv2 = DoubleConv(8*self.base_chanel,1)
        ...
        self.outconv1 = DoubleConv(4*self.base_chanel,1)
        ...
        self.conv10 = nn.Conv2d(2*self.base_chanel, 1, 1)
